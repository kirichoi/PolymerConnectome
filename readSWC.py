...
fig = plt.figure(figsize=(8,6))
plt.plot(np.tile(q_range[:60], (len(glo_idx)-2,1)).T, Pq_calyx_pn[:60])
...
fig = plt.figure(figsize=(8,6))
plt.plot(np.tile(q_range[:60], (len(glo_idx),1)).T, Pq_LH_pn[:60])
...
fig = plt.figure(figsize=(8,6))
plt.plot(np.tile(q_range[:60], (len(glo_idx),1)).T, Pq_AL_pn[:60])

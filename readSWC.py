...
plt.ylabel(r"$\nu$", fontsize=17)
plt.yticks(fontsize=14)
# plt.savefig(Parameter.outputdir + '/Pq_all_pn_calyx_neurite_mv_3.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel(r"$\nu$", fontsize=17)
plt.yticks(fontsize=14)
# plt.savefig(Parameter.outputdir + '/Pq_all_pn_LH_neurite_mv_3.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel(r"$\nu$", fontsize=17)
plt.yticks(fontsize=14)
# plt.savefig(Parameter.outputdir + '/Pq_all_pn_AL_neurite_mv_3.pdf', dpi=300, bbox_inches='tight')
plt.show()
